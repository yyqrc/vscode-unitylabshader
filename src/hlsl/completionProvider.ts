...
import { window, CompletionItemProvider, CompletionItem, CompletionItemKind, CancellationToken, TextDocument, Position, Range, TextEdit, workspace } from 'vscode';
...
export default class HLSLCompletionItemProvider implements CompletionItemProvider {
    ...
    public provideCompletionItems(document: TextDocument, position: Position, token: CancellationToken): Promise<CompletionItem[]> {
        ...
        window.showInformationMessage('provideCompletionItems');
