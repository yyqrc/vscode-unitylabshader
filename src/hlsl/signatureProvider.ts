...
export default class HLSLSignatureHelperProvider implements SignatureHelpProvider {
    ...
    public async provideSignatureHelp(document: TextDocument, position: Position, token: CancellationToken): Promise<SignatureHelp | null | undefined> {
        ...
        vscode.window.showInformationMessage('provideSignatureHelp');
